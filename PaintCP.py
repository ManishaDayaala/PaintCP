...
MAINFOLDER = r"./APPdata_PaintCP"

# Create other paths relative to the main folder
training_file_path = os.path.join(MAINFOLDER, "Training", "Training_PaintCP.xlsx")  # FIXED TRAINING DATA
test_file_path = os.path.join(MAINFOLDER, "24hrData", "Dailydata_PaintCP.xlsx")  # DAILY DATA
excel_file_path = os.path.join(MAINFOLDER, "Breakdownrecords_PaintCP.xlsx")  # Recording excel for BD
folderpath = os.path.join(MAINFOLDER, "TemporaryData")  # Temporary dump files collector
threshold_file_path = os.path.join(MAINFOLDER,"Thresholds_PaintCP.xlsx") 
...
st.markdown(
    ...
    <div style="display: flex; align-items: center;">
        ...
        <span style="font-size: {title_font_size}px; font-weight: bold;">Breakdown Predictor-Paint Bhooth-TH(CP)</span>
    </div>
...
def process_all_files():
    ...
    assets_list = [
        "Cold Air Blower MDE","Cold Air Blower MNDE","Fresh Air Blower MDE",
        "Fresh Air Blower MNDE","Hot Air Blower MDE","Hot Air Blower MNDE"]
